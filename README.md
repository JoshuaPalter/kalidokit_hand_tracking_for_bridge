...
-Once you've done that you'll see cool outlines on up to 2 hands in the webcam displayed to you. I haven't tested what would happen with additional hands in frame as I only have two, but I imagine that would break or confuse the program so maybe don't do that. (Unless you really want to!)
